...
#include "HolybroX500.generated.h"

// External Forces
constexpr float _M_AIR_DENSITY = 1225.0f; // N/m^3
constexpr float _M_DRAG_COEFF = 0.8f;

// Body force limits
constexpr float _M_MAX_LIN_ACCEL = 20.0f;
constexpr float _M_MAX_ANG_ACCEL = 2.0f;
 ...
 */
UCLASS()
class HOLODECK_API AHolybroX500 : public AHolodeckAgent {
    GENERATED_BODY()
